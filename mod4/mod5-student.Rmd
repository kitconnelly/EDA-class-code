...
ggplot(airquality_temp, aes(x = month_cat, y = Ozone, fill = relative_temp)) +
  geom_boxplot() +
  scale_x_discrete(name = 'Month') +
  scale_y_continuous(name = 'Ozone in\nparts per billion',
                     breaks = seq(0, 175, 25),
                     limits = c(0, 175)) +
  ggtitle('Ozone Quality During Summer Months') +
  theme_bw() +
  theme(axis.title = element_text(face = 'bold'),
        title = element_text(face = 'bold')) +
  scale_fill_brewer(palette = 'Accent') +
  guides(fill = guide_legend(title = 'Relative Temp'))
