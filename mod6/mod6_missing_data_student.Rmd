...
gg_miss_var(airquality, month_cat, show_pct = TRUE) +
...
matrixplot(airquality, sortby = 'month_cat')
```
...
# remove NAs
airquality %>% group_by(ozone_miss) %>%
  summarize(mean_wind = mean(Wind, na.rm = T),
